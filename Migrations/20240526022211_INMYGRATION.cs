...
namespace KhumaloCraftKC.Migrations
{
    /// <inheritdoc />
    public partial class INMYGRATION : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UimageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PRODUCT__B40CC6EDD6C8C00B", x => x.ProductID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BAFA0834EDA", x => x.OrderID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TRANSACT__55433A4BE1DFCAF3", x => x.TransactionID);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__TRANSACTI__Produ__52593CB8",
                        column: x => x.ProductID,
                        principalTable: "PRODUCT",
                        principalColumn: "ProductID");
                });
